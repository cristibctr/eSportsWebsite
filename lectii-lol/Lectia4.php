...
<body>
    <header class="lolheader4">
            <a href="Lectia3.php"><img src="../pictures/move-to-next-white.png" class="previous"></a>
            <a href="Lectia5.php"><img src="../pictures/move-to-next-white.png" class="next"></a>
...
?>
        ...
        <div class="bodylol4">
            <p class="lol4">După ce ți-ai ales campionul, vrăjile de invocator și pagina cu rune mai aveti putin timp sa discutati strategia cu echipa voastra. Dupa ce s-a incarcat jocul si ai intrat in meci trebuie sa iti cumperi de la magazinul de langa platforma cateva articole cu care sa te duci la lupta la inceput.</p>
           <img src="../pictures/shoplol.jpg" class="shoplol">
           <img src="../pictures/Shopkeeper.png" class="shopkeeper">
           <p class="lolpot">Potiunile reprezinta o idee excelenta la inceputul meciului pentru a putea sta in viata cat mai mult timp.</p>
    </main>
