...
<body>
    <header class="constrheader">
        <h1>Aceasta parte este in constructie</h1>
        <h2>Mai multe lectii vor fi postate in curand</h2>
...
?>
        ...
        <div class="constrbody">
            <img src="../pictures/constr.png">
        </div>
    </main>
